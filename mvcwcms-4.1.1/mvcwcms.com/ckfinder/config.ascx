...
<script runat="server">
    ...
    public override bool CheckAuthentication()
    {
        ...
        return (BackEndSessions.CurrentUser.IsNotNull() && BackEndSessions.CurrentUser.UserName.IsNotEmptyOrWhiteSpace());
    }
	...
	public override void SetConfig()
	{
        ...
        if (BackEndSessions.CurrentUser.IsNull() || BackEndSessions.CurrentUser.UserName.IsEmptyOrWhiteSpace())
        {
            return;
        }

		// The base URL used to reach files in CKFinder through the browser.
        BaseUrl = "/public/" + BitConverter.ToString(BackEndSessions.CurrentUser.UserName.ToBytes(Encoding.UTF8)).Replace("-", string.Empty);
        ...
        type.MaxSize = 1073741824; //1Gb - If it's not working you might need to change the Web.Config settings as well (executionTimeout, maxRequestLength, maxAllowedContentLength)
        type.AllowedExtensions = new string[] { "7z", "aiff", "asf", "avi", "bmp", "csv", "doc", "docx", "fla", "flv", "gif", "gz", "gzip", "ico", "jpeg", "jpg", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "ogg", "ogv", "pdf", "png", "ppt", "pptx", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "webm", "wma", "wmv", "xls", "xlsx", "zip" };
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add("Images");
        type.Url = BaseUrl + "Images/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "Images/";
        type.MaxSize = 10485760; //10Mb - If it's not working you might need to change the Web.Config settings as well (executionTimeout, maxRequestLength, maxAllowedContentLength)
        type.AllowedExtensions = new string[] { "gif", "jpg", "jpeg", "png" };
        type.DeniedExtensions = new string[] { };
        ...
        type.MaxSize = 1073741824; //1Gb - If it's not working you might need to change the Web.Config settings as well (executionTimeout, maxRequestLength, maxAllowedContentLength)
        type.AllowedExtensions = new string[] { "mov", "mp4", "ogg", "ogv", "webm" };
        type.DeniedExtensions = new string[] { };
	}
